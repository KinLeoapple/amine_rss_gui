<template>
    <perfect-scrollbar class="file-window" id="file-window">
    </perfect-scrollbar>
</template>
...
export default {
    ...
    methods: {
        ...
        fillFileDir() {
            let fileDirList = document.getElementById("file-window").querySelectorAll(".file-dir");
            fileDirList.forEach(dir => {
                if (dir.querySelectorAll(".file").length % 2 !== 0) {
                    dir.querySelector(".files").innerHTML +=
                        `<div class="file blank-file" file-name="">\n` +
                        "<div class=\"file-bg\">\n" +
                        "<div class=\"play-btn\">\n" +
                        "<i class=\"bi bi-play-fill\"></i>\n" +
                        "</div>\n" +
